...
from app.models import (
    ...
    OCRStatus, UserRole, Application
)
from app.repositories.document import DocumentRepository
from app.repositories.application import ApplicationRepository
from app.services.ocr import ocr_service, OCRError
...
class DocumentService:
    ...
    def get_document(
        ...
        if not self._can_view(document, user_id, user_role):
            raise DocumentPermissionError("You do not have permission to view this document")
    ...
    def get_application_documents(
        ...
        return self.doc_repo.get_by_application(application_id, include_versions=False)
    ...
    def get_ocr_autofill_suggestions(
        ...
        """
        documents = self.get_application_documents(application_id, user_id, user_role)
        ...
        for doc in documents:
            ...
            for field_path, value in field_mappings.items():
                ...
                confidence = confidence_scores.get(field_name, confidence_scores.get('overall', 0.0))
    ...
    def delete_document(
        ...
        if not self._can_delete(document, user_id, user_role):
            raise DocumentPermissionError("You do not have permission to delete this document")
